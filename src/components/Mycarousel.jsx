...
const Mycarousel = () => {
  return (
            ...
            <div className="col-md-2">
              <div className="cute-card">
                ...
                <div className="card-body text-center">
                  ...
                  <button className="signup-btn border-0 py-1 px-3">Purchase Now</button>
                </div>
              </div>
            </div>
    ...
    {/* Card 5 */}
            <div className="col-md-2">
              <div className="cute-card">
                <img src="/novel6.webp" className="card-img-top" alt="Cookie" />
                <div className="card-body text-center">
                  <h5 className="brand-text fs-5">The Stranger in My  House </h5>
                  {/* <p className="card-text small">Classic crunch in every bite.</p> */}
                  <button className="signup-btn border-0 py-1 px-3">Purchase Now</button>
                </div>
              </div>
